...
public class Q2_NodeHavingNoSiblings {
    ...
    public static void main(String[] args) {
        ...
        printNodesHavingNoSiblings(head);

    }

    public static void printNodesHavingNoSiblings(BinaryTreeNode<Integer> head) {
        if (head == null) {
            return;
        }
...
//        }
        ...
        if (head.left == null && head.right != null) {
            System.out.print(head.right.data + " ");
        }

        printNodesHavingNoSiblings(head.left);
        printNodesHavingNoSiblings(head.right);
    }
}
