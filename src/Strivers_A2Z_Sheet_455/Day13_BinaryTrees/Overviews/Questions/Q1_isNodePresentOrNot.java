...
public class Q1_isNodePresentOrNot {
    ...
    public static void main(String[] args) {
        ...
        if (checkIsNodePresentOrNot(head, 2)) {
            System.out.println("Yes Node Present");
        } else {
    ...
    public static boolean checkIsNodePresentOrNot(BinaryTreeNode<Integer> head, int x) {
        if (head == null) {
            return false;
        }
        ...
        return checkIsNodePresentOrNot(head.left, x) || checkIsNodePresentOrNot(head.right, x);
    }
}
